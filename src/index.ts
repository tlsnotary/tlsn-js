...
// import { LoggingLevel } from '../wasm/pkg';
//
...
//
// let _tlsn: any;
// const current_logging_filter = 'Info';
//
// async function getTLSN(logging_filter?: LoggingLevel): Promise<any> {
...
//  */
// export const set_logging_filter = async (logging_filter: LoggingLevel) => {
